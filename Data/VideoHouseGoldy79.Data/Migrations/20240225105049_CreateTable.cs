    ...
    public partial class CreateTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoviesActresses", x => new { x.MovieId, x.ActressId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReviewsAuthors", x => new { x.ReviewId, x.AuthorId });
                    table.ForeignKey(
                        name: "FK_ReviewsAuthors_Authors_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Authors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReviewsAuthors_Reviews_ReviewId",
                        column: x => x.ReviewId,
                        principalTable: "Reviews",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MoviesActresses_IsDeleted",
                table: "MoviesActresses",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReviewsAuthors_AuthorId",
                table: "ReviewsAuthors",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_ReviewsAuthors_IsDeleted",
                table: "ReviewsAuthors",
                column: "IsDeleted");
        }
